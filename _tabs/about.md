...
I am currently working towards a Ph.D. in the security group of the Department of Computer Science and Technology at the University of Cambridge, under the supervision of [Prof. Robert N. M. Watson][Watson]. I hold a [Bachelor of Advanced Computing][ANU] from the ANU, specialising in Computer Systems and Architecture, and a [M.Phil. in ACS][MPhil] from Cambridge, taking courses with the same focus on Systems, Architecture, and Security. Since the M.Phil., I have been researching hardware-assisted memory safety for language runtimes as a member of the [CTSRD-CHERI][CTSRD] group. I gratefully acknowledge the generous support from the [CASCADE Research Centre][CASCADE] in funding my Ph.D. studies. 
...
<!-- I am interested in exploring the design and analysis of cryptographic protocols that can be used to enhance the security and privacy of blockchain systems, such as zero-knowledge proofs, secure multi-party computation, and homomorphic encryption. This would require knowledge about cryptographic primitives, protocol design and analysis, and blockchain systems. -->
<!-- - privacy-preserving machine learning. I am interested in exploring the design and analysis of cryptographic protocols that can be used to enhance the security and privacy of blockchain systems, such as zero-knowledge proofs, secure multi-party computation, and homomorphic encryption. -->
<!-- - This would require knowledge about cryptographic primitives, protocol design and analysis, and blockchain systems. -->
...
[CTSRD]: https://www.cl.cam.ac.uk/research/security/ctsrd/
